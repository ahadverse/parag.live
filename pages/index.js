      ...
      <div className='page-bg'>
        ...
        >
          ...
          >
            ...
            {[
              {
                title: "Choose reputable escorts:",
                text: "Focus on verified escorts with positive reviews and ratings from previous clients.",
              },
              {
                title: "Protect your identity:",
                text: "Avoid sharing personal information, such as your full name, address, or financial details, with anyone on the platform.",
              },
              {
              ...
              },
              {
                ...
                text: "Prioritise meeting in a public place for your own safety. Inform a trusted friend or family member about your plans and whereabouts.",
              },
              {
                title: "Trust your instincts:",
                text: "If something feels off or suspicious, trust your gut and consider discontinuing communication or ending a meeting.",
              },
              {
              ...
              >
                <b style={{ color: "var(--accent)" }}>{tip.title} </b>
                {tip.text}
              </p>
            ))}
